...
Now, I could go back to previous turns and screenshot them all, crop the images, and create a GIF, but on every previous page Backstabbr includes the red and black "order resolutions" on the map.
